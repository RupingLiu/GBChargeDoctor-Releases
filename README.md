...
[![Auto Update](https://img.shields.io/badge/Auto_Update-enabled-22c55e?style=for-the-badge)](https://github.com/RupingLiu/GBChargeDoctor-Releases/releases/latest)
...
<div align="center">
  <img src="assets/gbcharge-doctor-current-zh-CN.png" alt="GBChargeDoctor 简体中文分析界面" width="100%">
</div>
...
| 步骤 | 操作 |
| --- | --- |
| 1 | 打开 [Release 下载页](https://github.com/RupingLiu/GBChargeDoctor-Releases/releases/latest)，下载最新版 Windows 安装包并安装。 |
...
请从 [GBChargeDoctor Releases](https://github.com/RupingLiu/GBChargeDoctor-Releases/releases/latest) 下载最新版安装包。该页面始终指向当前最新版本，也包含对应的更新说明。
...
| 更新校验 | 发布版本包含自动更新所需的清单和签名，用于安装包校验。 |
